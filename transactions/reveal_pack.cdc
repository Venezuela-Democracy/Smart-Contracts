...
/*         let receipt <- signer.storage.load<@VenezuelaNFT_16.Receipt>(from: VenezuelaNFT_16.ReceiptStoragePath)
            ?? panic("No Receipt found in storage at path=".concat(VenezuelaNFT_16.ReceiptStoragePath.toString())) */
