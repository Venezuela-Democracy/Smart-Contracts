...
// and stores it in the VenezuelaNFT_15 smart contract
...
transaction(
    ...
    let culturalItemEffects: VenezuelaNFT_15.CulturalItemEffects
    ...
    prepare(deployer: auth(BorrowValue) &Account) {
        ...
        self.currentCardId = VenezuelaNFT_15.nextCardID

        self.culturalItemEffects = VenezuelaNFT_15.CulturalItemEffects(
