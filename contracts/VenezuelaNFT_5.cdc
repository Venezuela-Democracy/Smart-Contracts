...
//    access(self) var culturalItemCardDatas: {UInt32: CulturalItemCard}
    ...
    access(all) struct Card {
        ...
        access(contract) fun updateTagline(tagline: String): UInt32 {
            ...
            // VenezuelaNFT_15.cardsDatas[self.CardID] = self
            return self.cardID
        }
    }
    ...
    access(all) resource Set {
        ...
        access(all) fun addCard(cardID: UInt32) {
            pre {
                VenezuelaNFT_15.cardDatas[cardID] != nil: "Cannot add the Card to Set: Card doesn't exist."
...
/*  		access(all) fun getMetadata(): CardData {
	...
	access(all) resource Collection: NonFungibleToken.Collection, VenezuelaNFT_15CollectionPublic {
        ...
        ///        
/*         access(all) fun borrowVenezuelaNFT_15(id: UInt64): &VenezuelaNFT_15.NFT? {
...
/* 		access(all) fun claim() {
    ...
    access(all) resource Administrator {
        ...
        access(all) fun createLocationCard(
            ...
            // for LocationCards
            VenezuelaNFT_15.cardDatas[newID] = newCard
            // emit event
