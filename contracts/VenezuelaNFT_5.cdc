...
//    access(self) var culturalItemCardDatas: {UInt32: CulturalItemCard}
    ...
    access(all) struct Card {
        ...
        access(contract) fun updateTagline(tagline: String): UInt32 {
            ...
            // VenezuelaNFT_13.cardsDatas[self.CardID] = self
            return self.cardID
        }
    }
    ...
    access(all) resource Set {
        ...
        access(all) fun addCard(cardID: UInt32) {
            pre {
                VenezuelaNFT_13.cardDatas[cardID] != nil: "Cannot add the Card to Set: Card doesn't exist."
...
/*  		access(all) fun getMetadata(): CardData {
	...
	access(all) resource Collection: NonFungibleToken.Collection, VenezuelaNFT_13CollectionPublic {
        ...
        ///        
/*         access(all) fun borrowVenezuelaNFT_13(id: UInt64): &VenezuelaNFT_13.NFT? {
            if self.ownedNFTs[id] != nil {
                // Create an authorized reference to allow downcasting
                let ref = (&self.ownedNFTs[id] as auth &NonFungibleToken.NFT?)!
                return ref as! &VenezuelaNFT_13.NFT
            }
...
/* 		access(all) fun claim() {
    ...
    access(all) resource Administrator {
        ...
        access(all) fun createLocationCard(
            ...
            // for LocationCards
            VenezuelaNFT_13.cardDatas[newID] = newCard
            // emit event
